...
const links = [
  {"name": "MyPortfolio", "url": "https://ianphuadev.web.app/"},
  {"name": "MyGithub", "url": "https://github.com/ian038"},
  {"name": "MyLinkedIn", "url": "https://linkedin.com/in/chai-ian-phua-915452b9/"},
]
...
async function handleRequest(request, links) {   
  ...
  if(request.url === "https://my-worker.ianphua.workers.dev/") {
  ...
  } else if(request.url === "https://my-worker.ianphua.workers.dev/links") {
